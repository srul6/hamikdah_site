    ...
    return (
        <Container maxWidth="md" sx={{ py: 4, mt: 8 }}>
            <Paper elevation={3} sx={{ p: 4, borderRadius: 2, direction: isHebrew ? 'rtl' : 'ltr' }}>
                <Typography variant="h3" sx={{ fontWeight: 600, color: 'rgb(229, 90, 61)', mb: 4, textAlign: 'center' }}>
                    {isHebrew ? 'קצת עלינו' : 'About Us'}
                </Typography>

                <Box sx={{ mb: 4 }}>
                    <Typography variant="h5" sx={{ fontWeight: 600, color: 'rgb(229, 90, 61)', mb: 2 }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" sx={{ mb: 0, lineHeight: 1.8 }}>
