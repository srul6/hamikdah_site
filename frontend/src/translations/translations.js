export const translations = {
    HE: {
        ...
        total: 'סה"כ',
        pay: 'שלם',
        securePayment: 'תשלום מאובטח באמצעות GreenInvoice',
        paymentSuccess: 'התשלום בוצע בהצלחה!',
        paymentFailed: 'התשלום נכשל. אנא נסה שוב.',
        fillRequiredFields: 'אנא מלא את כל השדות הנדרשים',
        processing: 'מעבד...',
        securePaymentGreenInvoice: 'תשלום מאובטח דרך חשבונית ירוקה',
    ...
    EN: {
        ...
        total: 'Total',
        pay: 'Pay',
        securePayment: 'Secure payment via GreenInvoice',
        paymentSuccess: 'Payment completed successfully!',
        paymentFailed: 'Payment failed. Please try again.',
        fillRequiredFields: 'Please fill in all required fields',
        processing: 'Processing...',
        securePaymentGreenInvoice: 'Secure payment through GreenInvoice',
